...
⚠️ **Margen de gracia (`AUTOMIX_RECENT_GRACE_MINUTES`).** En la practica, la
...
`AUTOMIX_RECENT_GRACE_MINUTES` (10 minutos por defecto), sin importar lo que
...
cortos, podes bajar `AUTOMIX_RECENT_GRACE_MINUTES` en el `.env` (por ejemplo
